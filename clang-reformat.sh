...
find include/boost/afio/detail -name *.hpp | xargs scripts/IndentCmacros.py
find include/boost/afio/detail -name *.ipp | xargs scripts/IndentCmacros.py
find test -name *.hpp | xargs scripts/IndentCmacros.py
find test -name *.cpp | xargs scripts/IndentCmacros.py
