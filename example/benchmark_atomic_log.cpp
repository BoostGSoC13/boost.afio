        ...
        try
        {
          ...
          while(!done)
          {
            ...
            "testdir/log.lock", file_flags::CreateOnlyIfNotExist |
                                file_flags::Write | file_flags::TemporaryFile |
      ...
      [&done, &attempts, &successes, n]
      {
        try
        {
          ...
          while(!done)
          {
            ...
            "testdir/1/log.lock", file_flags::CreateOnlyIfNotExist |
                                  file_flags::Write | file_flags::TemporaryFile |
                                  file_flags::DeleteOnClose));
            lockfiles.push_back(async_path_op_req(
            "testdir/2/log.lock", file_flags::CreateOnlyIfNotExist |
                                  file_flags::Write | file_flags::TemporaryFile |
                                  file_flags::DeleteOnClose));
            lockfiles.push_back(async_path_op_req(
            "testdir/3/log.lock", file_flags::CreateOnlyIfNotExist |
                                  file_flags::Write | file_flags::TemporaryFile |
                                  file_flags::DeleteOnClose));
            lockfiles.push_back(async_path_op_req(
            "testdir/4/log.lock", file_flags::CreateOnlyIfNotExist |
                                  file_flags::Write | file_flags::TemporaryFile |
                                  file_flags::DeleteOnClose));
            lockfiles.push_back(async_path_op_req(
            "testdir/5/log.lock", file_flags::CreateOnlyIfNotExist |
                                  file_flags::Write | file_flags::TemporaryFile |
                                  file_flags::DeleteOnClose));
            lockfiles.push_back(async_path_op_req(
            "testdir/6/log.lock", file_flags::CreateOnlyIfNotExist |
                                  file_flags::Write | file_flags::TemporaryFile |
                                  file_flags::DeleteOnClose));
            lockfiles.push_back(async_path_op_req(
            "testdir/7/log.lock", file_flags::CreateOnlyIfNotExist |
                                  file_flags::Write | file_flags::TemporaryFile |
                                  file_flags::DeleteOnClose));
            lockfiles.push_back(async_path_op_req(
            "testdir/8/log.lock", file_flags::CreateOnlyIfNotExist |
                                  file_flags::Write | file_flags::TemporaryFile |
                                  file_flags::DeleteOnClose));
...
#pragma pack(pop)
            ...
            auto iterate = [&]
            {
                  ...
                  buffersoffset -= sizeof(buffers))
              {
                ...
                dispatcher->read(make_async_data_op_req(lockfilez, (void *) buffers,
                                                        amount, buffersoffset))
                .get();
