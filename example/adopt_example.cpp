...
{
  test_handle(
      boost::afio::async_file_io_dispatcher_base *parent)
  ...
  virtual boost::afio::directory_entry direntry(
      boost::afio::metadata_flags wanted = boost::afio::
          directory_entry::metadata_fastpath()) const
  {
