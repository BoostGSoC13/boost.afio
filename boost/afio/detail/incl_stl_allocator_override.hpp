	...
	template<> class vector<BOOST_AFIO_TYPE_TO_BE_OVERRIDEN_FOR_STL_ALLOCATOR_USAGE, allocator<BOOST_AFIO_TYPE_TO_BE_OVERRIDEN_FOR_STL_ALLOCATOR_USAGE>> : public vector<BOOST_AFIO_TYPE_TO_BE_OVERRIDEN_FOR_STL_ALLOCATOR_USAGE, NiallsCPP11Utilities::aligned_allocator<BOOST_AFIO_TYPE_TO_BE_OVERRIDEN_FOR_STL_ALLOCATOR_USAGE>>
	{
		typedef vector<BOOST_AFIO_TYPE_TO_BE_OVERRIDEN_FOR_STL_ALLOCATOR_USAGE, NiallsCPP11Utilities::aligned_allocator<BOOST_AFIO_TYPE_TO_BE_OVERRIDEN_FOR_STL_ALLOCATOR_USAGE>> Base;
	public:
