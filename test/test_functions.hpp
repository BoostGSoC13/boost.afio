...
#define BOOST_AFIO_AUTO_TEST_CASE(__test_name, __desc, __timeout)                                                                                                                                                                                                                                                              \
  ...
  {                                                                                                                                                                                                                                                                                                                            \
    ...
    {                                                                                                                                                                                                                                                                                                                          \
      ...
      __deleter_t(std::shared_ptr<std::pair<BOOST_AFIO_V1_NAMESPACE::atomic<bool>, BOOST_AFIO_V1_NAMESPACE::condition_variable>> _cv, BOOST_AFIO_V1_NAMESPACE::thread &&_watchdog) : cv(std::move(_cv)), watchdog(std::move(_watchdog)) {}                                                                                     \
      ~__deleter_t()                                                                                                                                                                                                                                                                                                           \
      {                                                                                                                                                                                                                                                                                                                        \
        cv->first = true;                                                                                                                                                                                                                                                                                                      \
        cv->second.notify_all();                                                                                                                                                                                                                                                                                               \
