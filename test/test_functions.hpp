...
#  endif  /*_ !defined(__MINGW64_VERSION_MAJOR) _*/
...
# endif  /*_ defined(BOOST_AFIO_INCLUDE_SPOOKY_IMPL) _*/
...
# endif  /*_ !defined(RUNNING_ON_SANITIZER) _*/
...
# endif  /*_ !defined(BOOST_AFIO_TEST_ALL) _*/
# ifndef BOOST_TEST_MODULE
#  define BOOST_TEST_MODULE Boost.AFIO
# endif  /*_ !defined(BOOST_TEST_MODULE) _*/
...
# endif  /*_ !defined(BOOST_AFIO_USE_BOOST_UNIT_TEST) _*/
...
# else  /*_ BOOST_AFIO_USE_BOOST_UNIT_TEST _*/
...
# endif  /*_ BOOST_AFIO_USE_BOOST_UNIT_TEST _*/
...
# else  /*_ defined(MAXIMUM_TEST_CPUS) _*/
static inline void set_maximum_cpus(size_t no = 0)
{
}
# endif  /*_ defined(MAXIMUM_TEST_CPUS) _*/
...
# define BOOST_AFIO_TRAP_EXCEPTIONS_IN_TEST(callable)                                                                                                                                                                                                                                                                           \
  ...
  catch(const BOOST_AFIO_V2_NAMESPACE::system_error &e)                                                                                                                                                                                                                                                                        \
  {                                                                                                                                                                                                                                                                                                                            \
...
#  else  /*_ defined(BOOST_TEST_UNIT_TEST_SUITE_IMPL_HPP_071894GER) _*/
#   define BOOST_AFIO_AUTO_TEST_CASE_REGISTRAR(test_name)                                                                                                                                                                                                                                                                         \
...
#  endif  /*_ defined(BOOST_TEST_UNIT_TEST_SUITE_IMPL_HPP_071894GER) _*/
...
#  define BOOST_AFIO_AUTO_TEST_CASE(test_name, desc, _timeout)                                                                                                                                                                                                                                                                   \
  ...
  {                                                                                                                                                                                                                                                                                                                            \
    ...
    try                                                                                                                                                                                                                                                                                                                        \
    {                                                                                                                                                                                                                                                                                                                          \
      BOOST_AFIO_V2_NAMESPACE::filesystem::remove_all("testdir");                                                                                                                                                                                                                                                              \
    }                                                                                                                                                                                                                                                                                                                          \
    catch(...)                                                                                                                                                                                                                                                                                                                 \
    {                                                                                                                                                                                                                                                                                                                          \
    }                                                                                                                                                                                                                                                                                                                          \
    ...
    boost::unit_test::unit_test_monitor_t::instance().execute([&]() -> int                                                                                                                                                                                                                                                     \
                                                              {                                                                                                                                                                                                                                                                \
      BOOST_AFIO_V2_NAMESPACE::wrap_test_method(t);                                                                                                                                                                                                                                                                            \
      cv->first = true;                                                                                                                                                                                                                                                                                                        \
...
#  define BOOST_AFIO_AUTO_TEST_CASE(__test_name, __desc, __timeout)                                                                                                                                                                                                                                                              \
  ...
  {                                                                                                                                                                                                                                                                                                                            \
    ...
    {                                                                                                                                                                                                                                                                                                                          \
      ...
      __deleter_t(std::shared_ptr<std::pair<BOOST_AFIO_V2_NAMESPACE::atomic<bool>, BOOST_AFIO_V2_NAMESPACE::condition_variable>> _cv, BOOST_AFIO_V2_NAMESPACE::thread &&_watchdog)                                                                                                                                             \
          : cv(std::move(_cv))                                                                                                                                                                                                                                                                                                 \
...
static void dofilter(atomic<size_t> *callcount, detail::OpType, future<> &)
{
  ++*callcount;
}
...
# else  /*_ defined(DEBUG_TORTURE_TEST) _*/
struct Op
{
...
# endif  /*_ defined(DEBUG_TORTURE_TEST) _*/
...
#endif  /*_ !defined(BOOST_AFIO_TEST_FUNCTIONS_HPP) _*/
