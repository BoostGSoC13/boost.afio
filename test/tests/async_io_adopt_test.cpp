...
{
  test_handle(dispatcher *parent)
      : handle(parent, file_flags::none)
  {
  }
  ...
  virtual handle::open_states is_open() const override final { return handle::open_states::open; }
  virtual void *native_handle() const override final { return nullptr; }
  using handle::path;
  virtual afio::path path(bool refresh = false) override final { return "foo"; }
  virtual afio::path path() const override final { return "foo"; }
  virtual directory_entry direntry(metadata_flags wanted = directory_entry::metadata_fastpath()) override final { return directory_entry(); }
  virtual afio::path target() override final { return afio::path(); }
