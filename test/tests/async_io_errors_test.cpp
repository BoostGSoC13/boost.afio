...
# else  /*_ defined(BOOST_AFIO_RUNNING_IN_CI) || defined(BOOST_AFIO_COMPILING_FOR_GCOV) _*/
    for(size_t n = 0; n < 50000; n++)
# endif  /*_ defined(BOOST_AFIO_RUNNING_IN_CI) || defined(BOOST_AFIO_COMPILING_FOR_GCOV) _*/
    {
...
# endif  /*_ defined(WIN32) _*/
          ...
          if(hasErrorDirectly != 1)
          {
            ...
            for(auto &i : manyfilecreates)
            {
              ...
              {
                std::cerr << "Error was unknown type" << std::endl;
              }
            }
          }
...
#endif  /*_ !defined(BOOST_AFIO_THREAD_SANITIZING) _*/
