...
#endif  /*_ !defined(BOOST_AFIO_PACKEDTYPE) _*/
...
namespace detail
{
...
#else  /*_ defined(BOOST_WINDOWS) _*/
  extern "C" int posix_memalign(void **memptr, size_t alignment, size_t size);
#endif  /*_ defined(BOOST_WINDOWS) _*/
  ...
  */
  ...
  template <typename T, size_t TAlign, bool Tinit, typename U, size_t UAlign, bool Uinit> inline bool operator==(const aligned_allocator<T, TAlign, Tinit> &, const aligned_allocator<U, UAlign, Uinit> &) noexcept { return TAlign == UAlign; }
